...
// Permitir solo a camarero o admin crear reservas
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    // Si se accede directamente, redirigir a selección de salas
...
if (empty($errors)) {
    ...
    try {
        ...
        if ($start === false || $end === false) {
            ...
            // No permitir inicio en el pasado o presente (debe empezar en el futuro)
            if ($start <= $now) {
...
try {
    // Verificar reservas solapadas en la misma mesa y fecha
    $stmt = $conn->prepare(
