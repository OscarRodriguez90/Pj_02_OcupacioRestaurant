...
if ($nombre === '' || $idSala<=0 || $numSillas<=0) {
    header('Location: ../../../pages/admin/admin_mesas.php?error=DatosInvalidos');
    exit;
}
...
try {
    ...
    header('Location: ../../../pages/admin/admin_mesas.php?idSala=' . $idSala);
    exit;
} catch (PDOException $e) {
    header('Location: ../../../pages/admin/admin_mesas.php?idSala=' . $idSala . '&error=' . urlencode($e->getMessage()));
    exit;
}
