<?php
require_once '../processes/admin_salas_logic.php';
?>
<!doctype html>
<html lang="es">
<head>
...
<body class="page-sala">
  ...
  <main class="contenedor-principal admin-grid">
    ...
    <section class="info-sala">
      ...
      <form action="../processes/sala_create.php" method="post" enctype="multipart/form-data">
        ...
        <?php foreach($salas as $s): ?>
          <tr>
            ...
            <td>
              ...
              <a class="btn-danger js-delete" data-confirm="Eliminar sala?" href="../processes/sala_delete.php?id=<?= intval($s['idSala']) ?>">Eliminar</a>
