        ...
        <section class="info-sala">
            <?php if ($accion == 'crear' || $accion == 'editar'): ?>
                ...
                <div class="white-box">
                    ...
                    <?php if ($accion == 'crear'): ?>
                        <form id="form-crear-usuario" method="POST" action="../../processes/admin/admin_usuario/usuario_create.php">
                    <?php else: ?>
                        <form id="form-editar-usuario" method="POST" action="../../processes/admin/admin_usuario/usuario_update.php">
                            ...
                            <?php foreach ($usuarios as $u): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn-danger js-delete" data-confirm="Eliminar usuario?" href="../../processes/admin/admin_usuario/usuario_delete.php?id=<?php echo $u['idUsuario']; ?>">Eliminar</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
